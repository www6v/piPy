"""Amazon Bedrock provider adapter (minimal parity placeholder)."""
...
_PLACEHOLDER_ERROR = (
    "amazon-bedrock runtime is not implemented yet. "
    "A lightweight parity stub is registered for model discovery only."
)
